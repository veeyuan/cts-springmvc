	...
	<div class="container-fluid">
            <div class="card">
              <div class="card-header">
                ...
                <form:form id="questionForm" action ="manageQuestion.htm"  method="post" modelAttribute="question" >
				  ...
				  <%if ("Y".equals(request.getAttribute("hasQuestionAttachment"))){ %>	
					 <div class="form-row">				 
					  <div id="AAdiv" class="form-group col-md-8">
				 		...
				 		<img src="data:image/jpg;base64,${question.base64questionImage}" width="240" height="300"/>
				 		</div>
				 		</div>
				 		<%} %>
				   ...
				   <div class="form-row">
					 ...
					 <div class="form-row">				 
					  <div id="AAdiv" class="form-group col-md-8">
				 		...
				 		<img src="data:image/jpg;base64,${question.base64answerImage}" width="240" height="300"/>
				 		</div>
				 		</div>
				 		<%} %>
              ...
              <div class="card-footer clearfix">
                <button id="btn-addquestionset" type="submit" class="btn btn-info float-right"><i id="btn-icon" class="fas fa-edit"></i> Modify</button>             
